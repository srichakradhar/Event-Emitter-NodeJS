...
const queue = new AysncQueue();

queue.on('begin', () => console.log('About to execute'));
queue.on('end', () => console.log('Done with execute'));
...
queue.execute(readFile, 'https://jsonplaceholder.typicode.com/posts/1');
...
console.log(queue.rawListeners("begin"));
